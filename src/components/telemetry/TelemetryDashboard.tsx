...
export function TelemetryDashboard() {
  ...
  return (
    <section
      className="border-t border-[#5b5347]/20 bg-[#5b5347] transition-[height] duration-150"
    ...
    >
      ...
      {!collapsed && (
        ...
        >
          <span className="h-[2px] w-8 rounded-full bg-[#5b5347]/60 transition-colors group-hover:bg-[#5b5347]/80" />
        </div>
      )}

      {/* Header */}
      <div className="flex items-center justify-between border-b border-[#5b5347]/20 px-4 py-1.5">
        <div className="flex items-center gap-3">
          <h2 className="text-xs font-semibold uppercase tracking-wider text-[#f3ede2]/80">
            Telemetry Dashboard
          </h2>
          {/* View Toggle */}
          ...
          <button
            ...
            className={`flex items-center gap-1 rounded px-2 py-0.5 text-[10px] font-medium transition-colors border ${
              analysisPanelOpen
                ? 'bg-[#b8402e] text-[#f3ede2] border-[#b8402e]'
                : 'border-[#5b5347]/30 bg-[#5b5347]/80 text-[#f3ede2]/80 hover:text-[#f3ede2] hover:border-[#5b5347]/40'
            }`}
        ...
        <button
          ...
          className="rounded p-0.5 text-[#f3ede2]/80 hover:bg-[#5b5347]/80 hover:text-[#f3ede2]"
          ...
          {metrics === null ? (
            ...
            <>
              ...
              >
                {lastConfigWarning && (
                  <div
                    className="shrink-0 rounded-md border border-[#dfb357]/60/60 bg-[#dfb357]/15 px-3 py-1.5 text-[11px] text-[#dfb357]"
                    role="alert"
                  >
                ...
                >
                  {metrics.nodes.map((node) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex items-center gap-1.5 rounded border border-[#5b5347]/20 bg-[#211e1a] px-2 py-0.5 text-[10px] text-[#f3ede2]/90 hover:border-[#5b5347]/40"
                      >
                        <span
                        ...
                        <span className="font-mono text-[#f3ede2]/80">
                  ...
                  <span
                    className="ml-auto text-[9px] text-[#f3ede2]/70"
      ...
      <span className="flex items-center gap-1 text-[9px] text-[#f3ede2]/70">
        ...
        {tooltip && (
          <span className="group relative cursor-help" aria-label={tooltip}>
            <span className="inline-flex items-center text-[#f3ede2]/70 hover:text-[#f3ede2]/90">ℹ️</span>
            <span className="pointer-events-none absolute bottom-full left-1/2 z-50 mb-1 -translate-x-1/2 whitespace-normal rounded bg-[#5b5347]/60 px-2 py-1 text-[10px] leading-tight text-[#f3ede2] opacity-0 shadow-lg transition-opacity group-hover:opacity-100 w-48">
              {tooltip}
            </span>
          </span>
        )}
      </span>
      <span className="text-xs font-medium text-[#f3ede2]">{value}</span>
    </div>
  );
}
