...
export function AuthServiceNode({ id, data, selected }: NodeProps<AnalysysNode>) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-1.5 flex items-center justify-between">
        ...
        <span className="text-xs font-semibold text-amber-300">{config.concurrencyLimit}</span>
      </div>
